 ...
 */
export function isSizedFile(relPath, sourceWindow = DEFAULT_QUALITY.sourceWindow) {
    if (!sourceWindow.test(relPath))
        return false;
...
export function oversizedFiles(measured, { limit = DEFAULT_QUALITY.lineLimit, sourceWindow = DEFAULT_QUALITY.sourceWindow, } = {}) {
    return measured

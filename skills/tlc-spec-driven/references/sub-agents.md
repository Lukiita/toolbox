...
- `.specs/capabilities/` - the durable capability contract (regression anchor, maintained by the `capability-sync` skill; absent in projects that have not adopted it)

...
const EN: GateStrings = {
  ...
  footer: (generatedAt, originSuffix) =>
    `<sub>Generated by \`toolbox quality\` (@lukiita/toolbox) at ${generatedAt}${originSuffix}</sub>`,
...
const PT: GateStrings = {
  ...
  footer: (generatedAt, originSuffix) =>
    `<sub>Gerado por \`toolbox quality\` (@lukiita/toolbox) em ${generatedAt}${originSuffix}</sub>`,
  metricNotInBaseline: (metric) =>
